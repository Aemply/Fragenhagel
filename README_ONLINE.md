...
### v28 – Face Morph Lösung mit Originalbildern

Bei der aufgedeckten Face-Morph-Lösung werden die drei Bilder nebeneinander angeordnet:
**Originalbild 1 | Morph-Bild | Originalbild 2**.
